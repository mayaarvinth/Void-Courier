...
export default function VoidCourier() {
  ...
  const STORY_SLIDES = [
    { title: "On a normal Tuesday...", lines: ["Elijah Ward was just a normal mailman, exiting the mailtruck to drop off a package", "An eerie feeling washed over him as he stepped on the doorstep of the house", '"Is anyone there?"'] },
